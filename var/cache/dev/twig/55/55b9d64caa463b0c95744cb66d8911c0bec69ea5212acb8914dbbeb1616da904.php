...
class __TwigTemplate_ebe84f10518e24144f7cac7dd471b749ac091363f10bf8593d31967450e06ac0 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"bg-black text-white py-28\">
    <div class=\"min-h-screen dark:bg-gray-900 py-6 flex flex-col justify-center sm:py-12\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorie"]) {
            // line 12
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("quizz.show", ["id" => twig_get_attribute($this->env, $this->source, $context["categorie"], "id", [], "any", false, false, false, 12)]), "html", null, true);
            echo "\" class=\"bg-gray-300 border-red-600 dark:bg-gray-800 bg-opacity-95 border-opacity-60 | p-4 border-solid rounded-3xl border-2 | flex justify-around cursor-pointer | hover:bg-indigo-400 dark:hover:bg-indigo-600      hover:border-transparent | transition-colors duration-500\">
...
";
    ...
    {
        return array (  116 => 19,  106 => 15,  99 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"bg-black text-white py-28\">
    <div class=\"min-h-screen dark:bg-gray-900 py-6 flex flex-col justify-center sm:py-12\">
        <div class=\"grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 px-4\">
            ...
            <a href=\"{{ path('quizz.show', { 'id': categorie.id }) }}\" class=\"bg-gray-300 border-red-600 dark:bg-gray-800 bg-opacity-95 border-opacity-60 | p-4 border-solid rounded-3xl border-2 | flex justify-around cursor-pointer | hover:bg-indigo-400 dark:hover:bg-indigo-600      hover:border-transparent | transition-colors duration-500\">

                <div class=\"flex flex-col justify-center\">
                    <p class=\"text-gray-900 dark:text-gray-300 font-semibold\">{{ categorie.name }}</p>
                </div>
            </a>
            {% endfor %}
        </div>
...
{% endblock %}
", "quiz/index.html.twig", "/Users/maxencejoly/Desktop/W-PHP-502-MAR-2-2-Quiz-hugo.ribaud/my_quiz/templates/quiz/index.html.twig");
    }
}
