...
/* navbar.html.twig */
class __TwigTemplate_a43de2f77e4185abe21d19c708fe98405c3ed9bc136d97b8a5f10bad63f291ba extends Template
{
    private $source;
    private $macros = [];
    ...
    >
        ...
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 51, $this->source); })()), "user", [], "any", false, false, false, 51)) {
            ...
            <a
                    href=\"";
            // line 72
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("quizz.history", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 72, $this->source); })()), "user", [], "any", false, false, false, 72), "id", [], "any", false, false, false, 72)]), "html", null, true);
            echo "\"
                    class=\"h-10 leading-10 border-b-2 border-dotted md:border-none\">history</a>
            <a
                    href=\"";
            // line 75
...
";
    ...
    {
        return array (  151 => 78,  145 => 75,  139 => 72,  133 => 69,  127 => 66,  124 => 65,  118 => 62,  112 => 59,  106 => 56,  100 => 53,  97 => 52,  95 => 51,  43 => 1,);
    }
    ...
    >
        ...
        >
            ...
            <a
                    ...
                    class=\"h-10 leading-10 border-b-2 border-dotted md:border-none\">Quizz</a>
            <a
                    href=\"{{ path('quizz.history', { 'id': app.user.id}) }}\"
                    class=\"h-10 leading-10 border-b-2 border-dotted md:border-none\">history</a>
            <a
